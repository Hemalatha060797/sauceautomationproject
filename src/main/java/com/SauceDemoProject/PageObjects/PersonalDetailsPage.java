...
public class PersonalDetailsPage {
	...
	@FindBy(xpath = "//div[@class='col-lg-6 col-12']//select[@class='form-control form-control-lg custom-option radius-5 placholder-color ng-pristine ng-valid ng-touched']")
	@CacheLookup
	WebElement clkDropDown;

	@FindBy(xpath = "//div[@class='col-lg-6 col-12']//select[@class='form-control form-control-lg custom-option radius-5 placholder-color ng-pristine ng-valid ng-touched']//option")
	@CacheLookup

...
//    }
	 ...
	 public static WebDriver getDriver() {
	    ...
	    public void setUp(String browser, String version, String platform, String resolution) throws MalformedURLException {
	        ...
	        sauceOptions.put("build", "Final Build Cross Browser Testing:  Eccouncil Learning ");
		...
		if (browser.equalsIgnoreCase("chrome")) {
			...
			ieOptions.setCapability("browserVersion", version);
			ieOptions.setCapability("platformName", platform);
	    ...
	    public void setTestName(ITestResult result) {
	        ...
	        String fullTestName = "Test: " + testName + " - " + browser + " " + version + " " + platform;
